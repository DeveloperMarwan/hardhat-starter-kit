task("read-data-truflation", "Calls an API Consumer Contract to read data obtained from an external API")
    ...
    .setAction(async (taskArgs) => {
        ...
        let result = BigInt(await apiConsumerContract.inflationWei()).toString()
